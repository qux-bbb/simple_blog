...
class DeleteHandler(BackBaseHandler):
    ...
    def get(self):
        ...
        if (self.get_argument('article_name', None)):
            ...
            open("md/articlelist/articlelist.md" ,'w').write(articlelist_content.replace(listline ,""))
        ...
        articlelist_content = open("md/articlelist/articlelist.md" ,'r').read().replace("./article", "./delete")
